...
const TPOLayout = () => {
  ...
  const menuItems = [
    { name: "Profile", icon: <UserCircle size={20} />, path: "/tpo/profile" },
    { name: "Manage Drives", icon: <Briefcase size={20} />, path: "/tpo/drives" },
  ];
    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      >
        ...
        <div className="p-6 flex items-center gap-3 border-b">
          <div className="text-blue-600 font-extrabold text-2xl tracking-wide">
            TPO
          </div>
        </div>
